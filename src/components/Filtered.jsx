...
export const Filtered = (props) => {
  ...
  return (
    <div className="w-full h-fit flex-col flex items-center justify-start gap-4 p-2 h-screen card-div">
      {props.filteredArray.map((info, i) => {
        return (
          <div
            key={i}
          ...
          >
            ...
            <div className="flex flex-row items-center gap-4 cats">
              <button href="#" id={info.role} onClick={handleCat}>
                <span
                  id={info.role}
              ...
              <button href="#" id={info.level} onClick={handleCat}>
                <span
                  id={info.level}
                  className="bg-sky-100 text-cyan-700 p-2 rounded-md font-bold hover:bg-cyan-700 hover:text-slate-100"
                >
